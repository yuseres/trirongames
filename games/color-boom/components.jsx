...
const FEATURES = [
  {
    ...
    float: { em: "🖼️", big: "Library", small: "1,200+ canvases", pos: { top: "4%", left: "clamp(-10%, -3vw, 2%)" } },
    blob: "var(--purple)",
  },
  {
    ...
    float: { em: "🔥", big: "Day 2", small: "Streak active!", pos: { bottom: "8%", right: "clamp(-8%, -3vw, 2%)" } },
    blob: "var(--primary)",
    mini: "missions",
  },
  {
  ...
  },
  {
    ...
    float: { em: "💫", big: "Sparkle", small: "Effect equipped", pos: { bottom: "6%", left: "clamp(-8%, -3vw, 2%)" } },
    blob: "var(--blue)",
    mini: "game-shop",
  },
];
